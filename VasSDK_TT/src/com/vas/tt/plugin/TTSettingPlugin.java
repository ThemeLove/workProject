...
public class TTSettingPlugin implements ISettingPlugin
{

    public Activity mActivity;
    
    public TTSettingPlugin(Activity activity){
    ...
    {
        return true;//单接渠道sdk的时候，渠道有sdk退出框，返回true,没有的话返回false
    }
