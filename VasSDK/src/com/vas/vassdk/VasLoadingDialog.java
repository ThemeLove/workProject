...
import com.vas.vassdk.util.BackgroundUtil;
import com.vas.vassdk.util.ImageBase64Util;
import com.vas.vassdk.util.ScreenUtil;
 ...
 * Loading对话框
 */
public class VasLoadingDialog extends Dialog {
	...
	public VasLoadingDialog(Activity activity, String msg) {
		super(activity);
