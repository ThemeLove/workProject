...
public abstract class SyncHttpClient extends AsyncHttpClient {
    ...
    /*
     * as this is a synchronous request this is just a helping mechanism to pass the result back to
     * this method. Therefore the result object has to be a field to be accessible
     */
    ...
    protected AsyncHttpResponseHandler responseHandler = new AsyncHttpResponseHandler() {
        ...
        protected void sendMessage(Message msg) {
            /*
             * Dont use the handler and send it directly to the analysis (because its all the same
             * thread)
             */
            handleMessage(msg);
        }
