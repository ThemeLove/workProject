...
public class AsyncHttpClient {
    ...
    private static int socketTimeout = DEFAULT_SOCKET_TIMEOUT * 1;
    ...
    public AsyncHttpClient() {
        ...
        HttpProtocolParams
                .setUserAgent(httpParams, String.format("android-async-http/%s", VERSION));
     ...
     * @param context the Android Context which initiated the request.
     * @param url the URL to send the request to.
     * @param entity a raw {@link HttpEntity} to send with the request, for example, use this to
     *            send string/json/xml payloads to a server by passing a
