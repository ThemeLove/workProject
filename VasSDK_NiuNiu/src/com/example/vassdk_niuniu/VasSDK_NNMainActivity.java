package com.example.vassdk_niuniu;
...
public class VasSDK_NNMainActivity extends Activity
{
...
//                checkLogin(paramUserInfo.getUid(), paramUserInfo.getUserName(), paramUserInfo.getToken(), paramUserInfo.getExtra());
    ...
    private void showExitDialog(){
       // 游戏调用自身的退出对话框，点击确定后，调用quick的exit接口
        new AlertDialog.Builder(VasSDK_NNMainActivity.this).setTitle("退出").setMessage("是否退出游戏?").setPositiveButton(
