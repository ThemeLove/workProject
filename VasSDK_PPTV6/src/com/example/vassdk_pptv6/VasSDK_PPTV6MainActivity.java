package com.example.vassdk_pptv6;
...
public class VasSDK_PPTV6MainActivity extends Activity
{
    ...
    private void pay()
    {
        ...
        orderInfo.setAmount(0.01); // 总金额（单位为元）
    ...
    private void showExitDialog(){
     // 游戏调用自身的退出对话框，点击确定后，调用quick的exit接口
        new AlertDialog.Builder(VasSDK_PPTV6MainActivity.this).setTitle("退出").setMessage("是否退出游戏?").setPositiveButton(
