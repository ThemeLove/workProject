...
public class PPTVSDK
{
    ...
    private void channalPay(final VasOrderInfo orderinfo, VasRoleInfo roleInfo)
    {
        ...
        PptvVasAgent.startPayActivity(mActivity, roleInfo.getServerId(), roleInfo.getRoleId(),
                orderinfo.getExtrasParams(), 1, amount, orderinfo.getGoodsName(), orderinfo.getOrderId(),
                new PayListener()
                {
                    ...
                    {
                        VasSDK.getInstance().getVasPayCallback().onFailed(orderinfo.getCpOrderId(), arg0.getMessage(),
                                "");
                    }
