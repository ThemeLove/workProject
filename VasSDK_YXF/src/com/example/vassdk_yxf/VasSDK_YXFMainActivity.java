package com.example.vassdk_yxf;
...
public class VasSDK_YXFMainActivity extends Activity
{
    ...
    private void showExitDialog(){
     // 游戏调用自身的退出对话框，点击确定后，调用quick的exit接口
        new AlertDialog.Builder(VasSDK_YXFMainActivity.this).setTitle("退出").setMessage("是否退出游戏?").setPositiveButton(
